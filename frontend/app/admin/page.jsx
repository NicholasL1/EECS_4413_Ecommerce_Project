...
function page() {
  ...
  const DashboardMenu = (menu_items) => {
    return (
      <div
        id="DashboardMenu"
        className="w-1/12 border h-fit rounded-md shadow-sm bg-white"
      >
        <ul>
              ...
              <li key={i} className="w-full p-2 text-center">
                <button
                  ...
                  className={`w-full p-2 text-sm font-medium ${
                    item === selected_item
                      ? "bg-[#dd2c2c] text-white rounded-md shadow-md"
                      : ""
                  }`}
                  onClick={() => {
  ...
  return (
    <div id="container" className="">
      <div className="flex justify-items-center align-middle p-4 mt-8">
