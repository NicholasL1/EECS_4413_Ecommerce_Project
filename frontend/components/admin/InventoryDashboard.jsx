...

            {
                ...
                <div>
                    <div id="ProductSearch" className="flex py-2 my-2 justify-between align-middle">
                        <SearchTable placeholder={'Search Inventory'} setFilters={setFilters}/>
                        <button onClick={() => {setShowAddModal(true)}} className="h-[48px] w-[96px] px-4 rounded-md shadow-md bg-custom-black text-white">
